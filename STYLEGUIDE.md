...
This is a general style guide that shall govern over all `DomainAim` repositories. The aim is
...
- You must always use relative imports for imports within the `DomainAim` library
