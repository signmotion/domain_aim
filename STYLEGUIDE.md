...
This is a general style guide that shall govern over all **DomainAim** project. The aim is
...
- You must always use relative imports for imports within the `domain_aim` library
